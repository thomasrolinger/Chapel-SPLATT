...
CHPL_FLAGS=--permit-unhandled-module-errors -O --specialize --fast --no-llvm --local -suseNativeSyncVar=false --mem=${CHPL_MEM} --tasks=${CHPL_TASKS} --ccflags="-std=c99 -funroll-loops -fgnu89-inline -fstrict-aliasing -fPIC"
